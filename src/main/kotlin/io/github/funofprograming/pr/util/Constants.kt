...
val IS_WEIGHT_CAPPING_RUN = Key.of<AtomicBoolean>("IsWeightCappingRun")
...
val SECURITY_WEIGHT_CAPPER_REGISTRY = getGlobalContext("SECURITY_WEIGHT_CAPPER_REGISTRY")
val SECURITY_WEIGHT_CAPPING_STRATEGY_REGISTRY = getGlobalContext("SECURITY_WEIGHT_CAPPING_STRATEGY_REGISTRY")
